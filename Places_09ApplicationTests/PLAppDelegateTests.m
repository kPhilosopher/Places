...
#import "PLAppDelegateTests.h"

#define TITLE_OF_SCROLLABLEVIEWCONTROLLER @"Photo"

@implementation PLAppDelegateTests
...
- (void)testiPadConfiguration
{
	if([[UIScreen mainScreen] bounds].size.height > 500)
	{
		...
		STAssertTrue([[self.appDelegate.splitVC.viewControllers objectAtIndex:0] isKindOfClass:[PLTabBarController class]], @"For the iPad configuration, the master view controller of the split view controller is not a Tab Bar Controller");
		...
		PLTabBarController *tabcon = (PLTabBarController*)[self.appDelegate.splitVC.viewControllers objectAtIndex:0];
